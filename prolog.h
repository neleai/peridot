...
typedef struct {int class;char *ary; obj_fn *methods;} obj_Class;
...
obj Class(char *c){obj_Class  *o=malloc(sizeof(obj_Class));   o->class=5;o->ary=c;o->methods=calloc(sizeof(void*),100); return (obj)o;}
