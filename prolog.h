...
typedef struct {int class;char *ary; obj_fn *methods;} _obj_Class;
...
obj Class(char *c){_obj_Class *o=malloc(sizeof(_obj_Class));  o->class=5;o->ary=c;o->methods=calloc(sizeof(void*),100); return (obj)o;}
