...
it=rb_ary_new3(0);
 ...
 bind_aset(bind,1/*ary*/,it);  it=rb_obj_clone(c_18); arg0=it; it=rb_funcall(self,s_tokenPeridot_parser,1,arg0); FAILTEST(fail);int oldpos1=ame_getpos(self);
...
alt1_3: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 bind_aset(bind,5/*autovar*/,it); it=rb_funcall(self,s_atom_Peridot_parsercb_2Peridot_parser,1,bind);  it=rb_obj_clone(c_22); arg0=it; it=rb_funcall(self,s_seqPeridot_parser,1,arg0); FAILTEST(alt1_4);it=rb_funcall(self,s_atom_Peridot_parsercb_3Peridot_parser,1,bind);
 bind_aset(bind,2/*_result*/,it);  
ame_setcut(self,Qnil);goto accept1;
...
rb_define_method(cls_Peridot_parser,"sequence",Peridot_parser_sequence,0);
 rb_eval_string("testversionperidot('59217f34f40ec3a82aa7350a4530d8a6')");}
