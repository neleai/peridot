...
static VALUE sy_Peridot_parser_CCode2;
...
static VALUE sy_Peridot_parser_Method;
...
static VALUE sy_Peridot_parser__divide2;
static VALUE sy_Peridot_parser__divide3;
static VALUE sy_Peridot_parser__divide;
...
return it;
fail: return failobj; }
VALUE Peridot_parser_atom(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(12);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
it=rb_funcall(self,sy_Peridot_parser_CCode,1,bind);  bind_aset(bind,3/*_result*/,it);
...
it=rb_funcall(self,sy_Peridot_parser_If,1,bind);  bind_aset(bind,3/*_result*/,it);
...
alt2_2: ame_setpos(self,oldpos3);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
   it=AmethystCore_anything(self ); FAILTEST(alt2_3); bind_aset(bind,7/*autovar*/,it);
it=rb_funcall(self,sy_Peridot_parser__append5,1,bind);  
ame_setcut(self,Qnil);goto accept2;
  alt2_3:  ame_setpos(self,oldpos3); goto break1;
 accept2:;
 if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=rb_funcall(self,sy_Peridot_parser_CCode2,1,bind);  bind_aset(bind,3/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept1;
alt1_5: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=Peridot_parser_name(self ); FAILTEST(alt1_6); bind_aset(bind,8/*autovar*/,it);
...
alt3_1: ame_setpos(self,oldpos4);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt1_6;}
 it=bind_aget(bind,9/*autovar*/); bind_aset(bind,10/*name*/,it);
 it=rb_obj_clone(s_); arg0=it; it=rb_funcall(self,sy_seq,1,arg0); FAILTEST(alt3_2);  it=Peridot_parser_args(self ); FAILTEST(alt3_2); bind_aset(bind,11/*autovar*/,it);
it=rb_funcall(self,sy_Peridot_parser__append6,1,bind);  it=rb_obj_clone(s_2); arg0=it; it=rb_funcall(self,sy_seq,1,arg0); FAILTEST(alt3_2);it=rb_funcall(self,sy_Peridot_parser_Call,1,bind);  bind_aset(bind,3/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept3;
alt3_2: ame_setpos(self,oldpos4);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt1_6;}
 it=bind_aget(bind,9/*autovar*/); bind_aset(bind,10/*name*/,it);
it=rb_funcall(self,sy_Peridot_parser_,1,bind); FAILTEST(alt3_3);it=rb_funcall(self,sy_Peridot_parser_Var,1,bind);  bind_aset(bind,3/*_result*/,it);
...
int oldpos1; while(1){oldpos1=ame_getpos(self);  it=rb_funcall(self,sy_Peridot_parser__divide3,1,bind);  arg0=it; it=rb_funcall(self,sy_regch,1,arg0); FAILTEST(break1); bind_aset(bind,1/*autovar*/,it);
it=rb_funcall(self,sy_Peridot_parser__append,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,0/*autovar*/); bind_aset(bind,2/*x*/,it);
...
alt1_1: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 it=rb_obj_clone(s_8); arg0=it; it=rb_funcall(self,sy_seq,1,arg0); FAILTEST(alt1_2);  it=Peridot_parser_expr(self ); FAILTEST(alt1_2); bind_aset(bind,1/*expr*/,it);
...
int oldpos1; while(1){oldpos1=ame_getpos(self); int oldpos2=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos2);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
  it=rb_obj_clone(s_5); arg0=it; it=rb_funcall(self,sy_seq,1,arg0); FAILTEST(alt1_2);  it=Peridot_parser_args(self ); FAILTEST(alt1_2); bind_aset(bind,1/*arg*/,it);
 it=rb_obj_clone(s_6); arg0=it; it=rb_funcall(self,sy_token,1,arg0); FAILTEST(alt1_2);it=rb_funcall(self,sy_Peridot_parser_Method,1,bind);  
ame_setcut(self,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos2);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
  it=rb_obj_clone(s_7); arg0=it; it=rb_funcall(self,sy_seq,1,arg0); FAILTEST(alt1_3);  it=Peridot_parser_method(self ); FAILTEST(alt1_3); 
ame_setcut(self,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldpos2); goto break1;
 accept1:;
...
VALUE Peridot_parser_name(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(5);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
 ...
 it=rb_funcall(self,sy_Peridot_parser__divide,1,bind);  arg0=it; it=rb_funcall(self,sy_regch,1,arg0); FAILTEST(fail); bind_aset(bind,0/*s*/,it);
it=rb_ary_new3(0); bind_aset(bind,1/*autovar*/,it);
int oldpos1; while(1){oldpos1=ame_getpos(self);  it=rb_funcall(self,sy_Peridot_parser__divide2,1,bind);  arg0=it; it=rb_funcall(self,sy_regch,1,arg0); FAILTEST(break1); bind_aset(bind,2/*autovar*/,it);
it=rb_funcall(self,sy_Peridot_parser__append4,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,1/*autovar*/); bind_aset(bind,3/*it*/,it);
...
sy_Peridot_parser_CCode2=rb_intern("Peridot_parser_CCode2");
...
sy_Peridot_parser_Method=rb_intern("Peridot_parser_Method");
...
sy_Peridot_parser__divide2=rb_intern("Peridot_parser__divide2");
sy_Peridot_parser__divide3=rb_intern("Peridot_parser__divide3");
sy_Peridot_parser__divide=rb_intern("Peridot_parser__divide");
...
rb_define_method(cls_Peridot_parser,"sequence",Peridot_parser_sequence,0);
 rb_eval_string("testversionperidot('f637d8210f060a562d99e7cab1838467')");}
