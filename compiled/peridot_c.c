...
static VALUE s_root_Peridot_parsercb_1Peridot_parser;
...
alt1_2: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
  it=rb_obj_clone(c_14); arg0=it; it=rb_funcall(self,s_seqPeridot_parser,1,arg0); FAILTEST(alt1_3);  it=Peridot_parser_expr(self ); FAILTEST(alt1_3);
 bind_aset(bind,3/*e*/,it);  it=rb_obj_clone(c_15); arg0=it; it=rb_funcall(self,s_seqPeridot_parser,1,arg0); FAILTEST(alt1_3);it=bind_aget(bind,3/*e*/);
 bind_aset(bind,2/*_result*/,it);  
ame_setcut(self,Qnil);goto accept1;
alt1_3: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
  it=rb_obj_clone(c_16); arg0=it; it=rb_funcall(self,s_seqPeridot_parser,1,arg0); FAILTEST(alt1_4); it=rb_obj_clone(c_17); arg0=it; it=rb_funcall(self,s_tokenPeridot_parser,1,arg0); FAILTEST(alt1_4);  it=Peridot_parser_expr(self ); FAILTEST(alt1_4);
 bind_aset(bind,4/*expr*/,it);  it=rb_obj_clone(c_18); arg0=it; it=rb_funcall(self,s_tokenPeridot_parser,1,arg0); FAILTEST(alt1_4);  it=Peridot_parser_block(self ); FAILTEST(alt1_4);
...
alt1_4: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
  it=rb_obj_clone(c_19); arg0=it; it=rb_funcall(self,s_seqPeridot_parser,1,arg0); FAILTEST(alt1_5);int oldpos2; while(1){oldpos2=ame_getpos(self); int oldpos3=ame_getpos(self);
...
alt1_5: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 bind_aset(bind,7/*name*/,it);  it=rb_obj_clone(c_21); arg0=it; it=rb_funcall(self,s_seqPeridot_parser,1,arg0); FAILTEST(alt1_6);  it=Peridot_parser_expr(self ); FAILTEST(alt1_6);
 bind_aset(bind,8/*autovar*/,it); it=rb_funcall(self,s_atom_Peridot_parsercb_4Peridot_parser,1,bind);  it=rb_obj_clone(c_22); arg0=it; it=rb_funcall(self,s_seqPeridot_parser,1,arg0); FAILTEST(alt1_6);it=rb_funcall(self,s_atom_Peridot_parsercb_5Peridot_parser,1,bind);
 bind_aset(bind,2/*_result*/,it);  
ame_setcut(self,Qnil);goto accept1;
...
VALUE Peridot_parser_block(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(2);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
 ...
 it=rb_obj_clone(c_27); arg0=it; it=rb_funcall(self,s_tokenPeridot_parser,1,arg0); FAILTEST(fail);  it=Peridot_parser_sequence(self ); FAILTEST(fail);
 bind_aset(bind,0/*s*/,it);  it=rb_obj_clone(c_28); arg0=it; it=rb_funcall(self,s_seqPeridot_parser,1,arg0); FAILTEST(fail);it=bind_aget(bind,0/*s*/);
...
it=rb_ary_new3(0);
 ...
 bind_aset(bind,1/*ary*/,it);  it=rb_obj_clone(c_4); arg0=it; it=rb_funcall(self,s_tokenPeridot_parser,1,arg0); FAILTEST(fail); it=rb_obj_clone(c_5); arg0=it; it=rb_funcall(self,s_tokenPeridot_parser,1,arg0); FAILTEST(fail);  it=Peridot_parser_name(self ); FAILTEST(fail);
 bind_aset(bind,2/*name*/,it);  it=rb_obj_clone(c_6); arg0=it; it=rb_funcall(self,s_seqPeridot_parser,1,arg0); FAILTEST(fail);int oldpos1; while(1){oldpos1=ame_getpos(self); int oldpos2=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos2);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
  it=rb_obj_clone(c_7); arg0=it; it=rb_funcall(self,s_seqPeridot_parser,1,arg0); FAILTEST(alt1_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue); 
ame_setcut(self,Qnil);goto accept1;
...
ame_setcut(self,Qnil);goto accept1;
 ...
 bind_aset(bind,4/*autovar*/,it); it=rb_funcall(self,s_defi_Peridot_parsercb_2Peridot_parser,1,bind);  it=rb_obj_clone(c_8); arg0=it; it=rb_funcall(self,s_tokenPeridot_parser,1,arg0); FAILTEST(fail);it=rb_funcall(self,s_defi_Peridot_parsercb_3Peridot_parser,1,bind);
...
alt1_1: ame_setpos(self,oldpos2);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
  it=rb_obj_clone(c_23); arg0=it; it=rb_funcall(self,s_tokenPeridot_parser,1,arg0); FAILTEST(alt1_2);
 bind_aset(bind,1/*op*/,it);  
ame_setcut(self,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos2);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
  it=rb_obj_clone(c_24); arg0=it; it=rb_funcall(self,s_tokenPeridot_parser,1,arg0); FAILTEST(alt1_3);
 bind_aset(bind,1/*op*/,it);  
ame_setcut(self,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldpos2); goto break1;
 accept1:;
...
VALUE Peridot_parser_mulexpr(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(4);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
 ...
 bind_aset(bind,0/*a*/,it); int oldpos1; while(1){oldpos1=ame_getpos(self); int oldpos2=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos2);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
  it=rb_obj_clone(c_25); arg0=it; it=rb_funcall(self,s_tokenPeridot_parser,1,arg0); FAILTEST(alt1_2);
 bind_aset(bind,1/*op*/,it);  
ame_setcut(self,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos2);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
  it=rb_obj_clone(c_26); arg0=it; it=rb_funcall(self,s_tokenPeridot_parser,1,arg0); FAILTEST(alt1_3);
 bind_aset(bind,1/*op*/,it);  
ame_setcut(self,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldpos2); goto break1;
 accept1:;
...
ame_setcut(self,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
  it=rb_obj_clone(c_9); arg0=it; it=rb_funcall(self,s_tokenPeridot_parser,1,arg0); FAILTEST(alt1_3);
 bind_aset(bind,0/*s*/,it);  
ame_setcut(self,Qnil);goto accept1;
...
it=rb_ary_new3(0);
 ...
 bind_aset(bind,1/*autovar*/,it); it=rb_funcall(self,s_root_Peridot_parsercb_1Peridot_parser,1,bind); int oldpos1; while(1){oldpos1=ame_getpos(self);   it=rb_funcall(self,s_endlinePeridot_parser,0); FAILTEST(break1);  it=Peridot_parser_expr(self ); FAILTEST(break1);
 bind_aset(bind,2/*autovar*/,it); it=rb_funcall(self,s_sequence_Peridot_parsercb_1Peridot_parser,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=rb_funcall(self,s_sequence_Peridot_parsercb_2Peridot_parser,1,bind);
 bind_aset(bind,3/*_result*/,it); it=bind_aget(bind,3/*_result*/);
return it;
fail: return failobj; }
void Init_peridot_c(){ 
...
c_16=rb_str_new2("if");rb_ary_push(rb_const_get(rb_cObject,rb_intern("GC_mark")),c_16);
...
c_23=rb_str_new2("+");rb_ary_push(rb_const_get(rb_cObject,rb_intern("GC_mark")),c_23);
...
c_4=rb_str_new2("def");rb_ary_push(rb_const_get(rb_cObject,rb_intern("GC_mark")),c_4);
...
c_8=rb_str_new2("end");rb_ary_push(rb_const_get(rb_cObject,rb_intern("GC_mark")),c_8);
...
rb_define_method(cls_Peridot_parser,"sequence",Peridot_parser_sequence,0);
 rb_eval_string("testversionperidot('9a482940b95dbd2f88558360f3aad6c3')");}
