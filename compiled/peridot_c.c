...
it=rb_ary_new3(0);
 ...
 bind_aset(bind,1/*ary*/,it);  it=rb_obj_clone(c_14); arg0=it; it=rb_funcall(self,s_tokenPeridot_parser,1,arg0); FAILTEST(fail);int oldpos1=ame_getpos(self);
...
alt1_2: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
  it=rb_obj_clone(c_15); arg0=it; it=rb_funcall(self,s_seqPeridot_parser,1,arg0); FAILTEST(alt1_3);int oldpos2; while(1){oldpos2=ame_getpos(self); int oldpos3=ame_getpos(self);
alt2_1: ame_setpos(self,oldpos3);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
  it=rb_obj_clone(c_16); arg0=it; it=rb_funcall(self,s_seqPeridot_parser,1,arg0); FAILTEST(alt2_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue); 
...
alt1_3: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 bind_aset(bind,4/*name*/,it);  it=rb_obj_clone(c_17); arg0=it; it=rb_funcall(self,s_seqPeridot_parser,1,arg0); FAILTEST(alt1_4);  it=Peridot_parser_expr(self ); FAILTEST(alt1_4);
 bind_aset(bind,5/*autovar*/,it); it=rb_funcall(self,s_atom_Peridot_parsercb_2Peridot_parser,1,bind);  it=rb_obj_clone(c_18); arg0=it; it=rb_funcall(self,s_seqPeridot_parser,1,arg0); FAILTEST(alt1_4);it=rb_funcall(self,s_atom_Peridot_parsercb_3Peridot_parser,1,bind); 
 bind_aset(bind,2/*_result*/,it);  
ame_setcut(self,Qnil);goto accept1;
...
it=rb_ary_new3(0);
 ...
 bind_aset(bind,1/*ary*/,it);  it=rb_obj_clone(c_6); arg0=it; it=rb_funcall(self,s_tokenPeridot_parser,1,arg0); FAILTEST(fail); it=rb_obj_clone(c_7); arg0=it; it=rb_funcall(self,s_tokenPeridot_parser,1,arg0); FAILTEST(fail);  it=Peridot_parser_name(self ); FAILTEST(fail);
 bind_aset(bind,2/*name*/,it);  it=rb_obj_clone(c_8); arg0=it; it=rb_funcall(self,s_seqPeridot_parser,1,arg0); FAILTEST(fail);int oldpos1; while(1){oldpos1=ame_getpos(self); int oldpos2=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos2);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
  it=rb_obj_clone(c_9); arg0=it; it=rb_funcall(self,s_seqPeridot_parser,1,arg0); FAILTEST(alt1_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue); 
ame_setcut(self,Qnil);goto accept1;
...
ame_setcut(self,Qnil);goto accept1;
 ...
 bind_aset(bind,4/*autovar*/,it); it=rb_funcall(self,s_defi_Peridot_parsercb_2Peridot_parser,1,bind);  it=rb_obj_clone(c_10); arg0=it; it=rb_funcall(self,s_tokenPeridot_parser,1,arg0); FAILTEST(fail);it=rb_funcall(self,s_defi_Peridot_parsercb_3Peridot_parser,1,bind);
...
VALUE Peridot_parser_expr(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(3);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
 ...
 bind_aset(bind,0/*a*/,it); int oldpos1; while(1){oldpos1=ame_getpos(self);  it=rb_obj_clone(c_2); arg0=it; it=rb_funcall(self,s_tokenPeridot_parser,1,arg0); FAILTEST(break1);  it=Peridot_parser_mulexpr(self ); FAILTEST(break1);
...
VALUE Peridot_parser_mulexpr(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(3);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
 ...
 bind_aset(bind,0/*a*/,it); int oldpos1; while(1){oldpos1=ame_getpos(self);  it=rb_obj_clone(c_3); arg0=it; it=rb_funcall(self,s_tokenPeridot_parser,1,arg0); FAILTEST(break1);  it=Peridot_parser_atom(self ); FAILTEST(break1);
...
c_10=rb_str_new2("end");rb_ary_push(rb_const_get(rb_cObject,rb_intern("GC_mark")),c_10);
...
c_6=rb_str_new2("def");rb_ary_push(rb_const_get(rb_cObject,rb_intern("GC_mark")),c_6);
...
rb_define_method(cls_Peridot_parser,"root",Peridot_parser_root,0);
 rb_eval_string("testversionperidot('d127e135fc9bce16dcc6463b01c2f776')");}
